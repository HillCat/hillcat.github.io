...
最终的效果大致如下:mp4和mp3可以帮助回忆剧情，复习口语，复习的时候也可以模仿跟读。同时兼顾了听力/口语/阅读积累。而且日后这些卡片还可以导出，打印出来，作为口语和写作的输出材料。
...
在接下来的安装过程中，如果`chocolatey/mpv/youtube-dl/ffmpeg`中的某些软件安装失败，请考虑是否是以下问题导致:
