...
本文主要介绍看美剧制作单词卡片。视频卡片主要解决的是如何复习如何整理美剧笔记的问题，如果没有单词卡片，也不做任何笔记，那么大部分人看剧的时候，看过了基本就忘记了，有时候被剧情吸引而忘记了学英语这件事情。传统的复习方式只能是反复看很多遍美剧来复习，以前这种传统方式太枯燥而又浪费时间。如果你把一个美剧里面的经典口语台词做成视频卡片的方式，就能够克服传统方式学美剧的缺点，并且很多剧只需要看3遍就差不多了，日后相当长的时间。只需要掏出手机复习这些视频单词卡片即可。而不需要反复回头去看很多遍。

看美剧制作单词卡片就跟做笔记一样，是为了增强记忆，把经典的句子摘抄下来，把重要内容记录到卡片上，使用零碎时间在手机上复习，这种卡片以视频和音频方式回放，因为都被提取为了一个个小知识点，所以不需要回过头把整个剧都反复去刷，复习这些小知识点即可。甚至还可以做跟读训练，传统方式能够训练到的听力口语，用这种视频卡片的方式同样也能够训练到，并且更加节约时间。

如果不使用这种anki单词卡的方法，也可以借鉴下别人的一些方式，比如，下面这种：
...
里面提到了`随时温习，处处操练，随时引用`，视频卡片也能做到这种效果。
