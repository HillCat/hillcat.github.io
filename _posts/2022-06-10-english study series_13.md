...
在操作之前，**强烈建议**把文件夹视图调整为：显示文件名后缀；并且电脑开启全局帆樯。如果安装失败，请考虑是否是樯的问题，或是系统完整性导致的问题(尽量使用微软官方iso系统镜像安装windows系统，激活码在淘宝10元店有售)。
...
区分字体颜色之后，做出来的卡片一目了然。也能够更加突出重点。实际使用来看，美剧制作的卡片，难度要比有声书/外刊/新闻这些题材来源的卡片简单太多，而且也更加符合口语习惯，总之一句话: 用它来刷剧，真香!
