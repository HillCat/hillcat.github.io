...
本文介绍的这种anki制卡方法，最早可以追溯到subs2srs制卡，来至于youtube，B站搜索`subs2srs`也能够找到教材。文本这次用的是另外一个插件，跟subs2srs差不多，2个插件都是同一个作者。

视频卡片的效果如下：其实B站里面也有很多人发布了用视频制作anki卡片的视频。只是不太系统，有的方法已经过期或者失效。下面直接讲操作步骤。
