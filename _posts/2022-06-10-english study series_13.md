...
我的环境配置：window10 pro Version 22H2 (中文界面改为了英文界面)；Anki Version ⁨2.1.55 QT5(英文界面)。如果安装遇到问题，建议你重装一个纯净的windows系统，选择用微软官方的系统镜像刻录系统盘安装，那样子的系统会跟正版系统一样，装完后去淘宝买个序列号激活即可。
