...
Anki用来进行美剧制卡，提供了看美剧复习英语知识点的便利，除了NetFlix之外，一切可以下载到的youtube show,TV show只要是英文的都可以这么操作。这里说的看剧主要是以英文字幕为主，中文字幕为辅。
...
基于以上的策略，美剧先解决零碎的听懂，需要大量看生活剧，之后再过渡到，能够就某一个话题，进行持续口语输出，其实在持续输出口语之前，还有个阶段需要自己每天用英文，用自己的话去总结，慢慢才能训练起来口语能力，具体可以参考`Ruri Ohama`的亲身经历：[https://youtu.be/NQlFIrSZiIE](https://youtu.be/NQlFIrSZiIE)。anki+mpv这种制卡的方式是一个不错的进入美剧学习这个领域的`起手式`。首先解决如何做笔记、如何整理笔记、如何高效复习3大问题。从一个点切入，为快速过渡到真正的口语输出阶段节约时间。
