...
能够不开字幕看懂大部分的youtube视频和美剧的时候，几乎就不需要借助anki这种单词工具了，这个时候可以进入下一个阶段。下一阶段是回到看书上面来，每当看完一个章节的时候，尝试着自己用英语讲述你看到的这个章节都讲了些什么内容，发表下自己的看法等等，这种训练方式需要有前提基础，就是前期你已经进行了大量的美剧输入(各种TV Show，访谈节目)，并且使用anki复习了很多这种卡片，已经有了基础的前提下。然后用自己的语言尝试去复述文章内容，以口语的形式复述出来。这种复述过程，会用到之前积累的这些卡片素材，坚持一段时间之后，口语能力就会大大提升。我以前学anki的时候就看了大量的`Matt vs Japan`的youtube视频，得到了不少灵感。如果要寻找其他`自学语言`的成功经验，建议去关注`Ruri Ohama`，`Matt vs Japan`，`Giovanni Smith`等等这些youtube播主。当然，除了这些播主之外，技术类IT播主我也关注了很多，总之，筛选英文视频媒体资源的能力。取决于你对youtube和NetFlix的熟悉程度。(帆樯是前提条件)。
