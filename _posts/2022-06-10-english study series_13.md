...
下面是一张我制作好的美剧卡片，上面这个按钮是播放mp4，下面那个按钮是播放mp3。中间这个部分是英文台词和自己做的一些备注，复习的时候，会播放这个mp4视频和声音，下面那些台词和备注都是不会显示的；要尝试着用听力的方式听出来那些台词，然后回忆整句话的意思，这样子做可以训练我们的听力能力；卡片的背面，会显示答案，就是显示台词和你做的备注。通过听的方式来复习。成千上万张视频美剧卡，在复习几十万次之后，相信你的口语听力会很快提升。

![66667777](/images/posts/66667777.gif)

我相信，在语言自学这个领域，anki算是为数不多的好工具之一。

我的环境配置：window10 pro Version 22H2 (中文界面改为了英文界面)；Anki Version ⁨2.1.55 QT5(英文界面)。如果安装遇到问题，建议你重装一个纯净的windows系统，选择用微软官方的系统镜像刻录系统盘安装，那样子的系统会跟正版系统一样，装完后去淘宝买个序列号激活即可。同时建议帆樯采用软路由帆樯，比较稳定。
