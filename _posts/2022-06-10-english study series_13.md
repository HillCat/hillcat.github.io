...
甚至你觉得这样子用快捷键不爽，可以使用游戏手柄，映射到键盘组合键上，这样子就不需要那么累。游戏手柄采用USB那种，映射软件使用:[https://github.com/AntiMicroX/antimicrox](https://github.com/AntiMicroX/antimicrox)，之前阅读有声书和原版书的时候，我复习anki卡片就是使用游戏手柄，这个映射软件可以把2个组合键，映射手柄上的1个键。还是比较省力的。如果是键盘，很多操作都要同时按住2个键，时间久了累，而且键盘操作本身就不灵敏，不适合长时间高精度切片操作。关键是，时间长了，血液不循环，挺累的。换成游戏手柄之后，我的手想怎么放就怎么放。这个只是顺带提一下。有点另类，当你遇到这个问题的时候，希望可以想到还有这么个方法。
