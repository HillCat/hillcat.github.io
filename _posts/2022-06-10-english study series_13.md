...
使用anki + mpv的方式，主要是解决看剧过程中如何做笔记，如何复习的问题，提高效率，同时也为了和原版书，有声书之前的词汇积累，起到一个相撞的作用，因为通过有声书或者原版书，新闻积累起来的词汇很可能在美剧这些材料中重新遇到，把这些积累都汇聚到anki中，可以起到相互交织作用，形成一个全面的记忆网。复习卡片的时候，对于一些比较好的经典句型，可以归类到某一个指定的Deck中，积累为自己的口语话术素材，为以后自己写作和口语输出训练节省精力和时间。
