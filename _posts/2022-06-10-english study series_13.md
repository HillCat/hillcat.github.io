...
本方法可用来修炼美剧，锻炼口语；根据选择的视频种类会有不同，比如：youtube的TED演讲倾向于口语逻辑组织能力。而美剧倾向于日常口语，前者口语比较缜密，后者口语比较松散。yotube播主自说自话的视频，倾向于个人表达。通过本文介绍的视频制卡方法食用不同类型的视频，以获得不同视频类型的学习经验积累。对于融会贯通口语/听力有积极作用。
