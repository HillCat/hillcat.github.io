...
这种方法，其实跟国外大神们使用的方法基本上一样了，缺点是，还是需要手工查词典，或者借助人工智能AI翻译，来搞定整个台词的翻译。我的建议是，同时chrome浏览器打开NetFlix，配合Language Reactor插件开启中英文双语字幕，我们结合本地视频的播放，可以快速定位到本地播放的那句台词，Language Reactor插件一定是chrome浏览器看NetFlix和youtube视频的神器来的。关键的配置截图如下：这里的中文翻译可不是野生字幕组翻译的，这是NetFlix提供的真实的人工翻译。
