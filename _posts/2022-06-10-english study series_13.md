...
使用anki + mpv的方式，主要是解决看剧过程中如何做笔记，如何复习的问题，提高效率，同时也为了和原版书，有声书之前的词汇积累，起到一个相撞的作用，因为通过有声书或者原版书，新闻积累起来的词汇很可能在美剧这些材料中重新遇到，把这些积累都汇聚到anki中，可以起到相互交织作用，形成一个全面的记忆网。复习卡片的时候，对于一些比较好的经典句型，可以归类到某一个指定的Deck中，积累为自己的口语话术素材，为以后自己写作和口语输出训练节省精力和时间(以后肯定要想起来某个句型的时候，要用到自己的输出上，从这个素材库取就可以了)。
...
能够不开字幕看懂大部分的youtube视频和美剧的时候，几乎就不需要借助anki这种单词工具了，这个时候可以进入下一个阶段。下一阶段是回到看书上面来，每当看完一个章节的时候，尝试着自己用英语讲述你看到的这个章节都讲了些什么内容，等于是用自己的语言转述文章内容，以口语的形式讲出来。刚开始的时候总是用蹩脚的英语自言自语，会感觉到自己像个神经病，坚持一段时间之后，口语能力就会大大提升。我以前学anki的时候就看了大量的`Matt vs Japan`的youtube视频，得到了不少灵感。如果要寻找这块的真实经验，建议去关注`Ruri Ohama`，`Matt vs Japan`，`Giovanni Smith`等等这些youtube播主。
