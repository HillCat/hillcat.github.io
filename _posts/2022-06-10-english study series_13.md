...
我的环境配置：window10 pro Version 22H2 (中文界面改为了英文界面)；Anki Version ⁨2.1.55 QT5(英文界面)。如果安装遇到各种奇葩报错问题，首先检查你系统是否是纯净完整的，不要用那种阉割的电脑城装机Ghost克隆版本系统，系统被阉割过很容易出问题，如果电脑系统有问题请重装系统，安装纯净完整版系统。另外，安装过程开启全局帆樯，帆樯能力对于学英语很重要，没有这个，看奈飞，看YouTube统统歇菜。
