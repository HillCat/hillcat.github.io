...
基于以上的策略，美剧先解决零碎的听懂，需要大量看生活剧，之后再过渡到，能够就某一个话题，进行持续口语输出。anki+mpv这种制卡的方式是一个不错的起手式。首先解决如何做笔记、如何整理笔记、如何高效复习3大问题。从一个点切入，之后慢慢寻找机会精进突破。

**学到什么程度就不需要anki了？**

能够不开字幕看懂大部分的youtube视频和美剧的时候，几乎就不需要借助anki这种单词工具了，这个时候可以进入下一个阶段。下一阶段还是需要看剧，但是尝试着自己用英语讲述你看到的这些剧都讲了些什么内容，等于是用自己的语言总结一天发生和经历的事情，刚开始的时候总是用蹩脚的英语自言自语，会感觉到自己像个神经病，坚持一段时间之后，口语能力就会大大提升。具体可以参考`Ruri Ohama`的亲身经历：[https://youtu.be/NQlFIrSZiIE](https://youtu.be/NQlFIrSZiIE)。类似的经历过程，在油管还有很多，如果你的听力和英文基础还行，可以去搜youtube，不要用中文，一定要形成用英文搜索信息的习惯，看看别人学语言的亲身体验和感悟。我以前学anki的时候就看了大量的`Matt vs Japan`的youtube视频，得到了不少灵感。
