...
美剧还有一个缺点就是切换材料相对书本而言，切换比较迟钝，试错成本高。比如生活类的美剧，偏向于零碎的英文口语，并不能很好的锻炼到自我语言组织逻辑。观看生活类的口语可能需要几个月甚至半年积累，然后切换到TED演讲类英文这种语言组织和逻辑比较缜密的材料，而雅思口语考试很多时候倾向于TED这种类型，就是给一个话题，要你自己组织语言。美剧无法解决这个语言组织能力的问题。只能解决日常生活口语的问题，因为这些都是零碎的情景口语，不需要你滔滔不绝演讲，大段大段组织逻辑。如果要更上一层楼，完全用口语进行20分钟的不间歇表达这种，还得锻炼逻辑组织能力，需要引入写作训练。一开始可能无法达到那么高的水准，可以先从最简单的开始，先从生活类这种题材开始下手，慢慢过渡到可以就某一个话题持续20分钟的口语输出这种。这是一个漫长的训练体系，难的地方在于如何开始。

基于以上的策略，美剧从何下手，先解决零碎的这种美剧对话可以听懂，需要大量看美剧学英语，anki+mpv这种制卡的方式是一个不错的解决办法。首先解决以下3个关键问题：1.美剧如何做笔记，2.美剧如何整理笔记，3.美剧如何高效复习。学美剧的第一步，相信就会遇到这3个问题。首先解决这个3个问题，就会有一个比别人更好的开端。美剧这一级台阶并非是从零开始的，至少需要有3000~5000基础词汇量和一定的听力能力。基础太差，很难坐的住，潜下心来搞美剧。英文基础低于以上水准，还是需要补充阅读词汇量和基本的听力能力。

切换不同的方法每次需要很长的适应期，比如从阅读切换到美剧，为了度过适应期，英语学习可能需要停顿2~3个月甚至半年时间，以用来适应进入到一个新阶段，这可能中断我们以前好不容易形成的学习习惯，可能有些人学了2年，都是用的阅读，一下子切到美剧，不知道从何下手。可能导致某些`长期已经成型的习惯`被打破。而传统的复习方法，受材料的限制较大，很多时候都是针对于阅读的，没有太多好的复习方法针对美剧或电视节目这种，anki的引入，希望能够打破这种僵局，使得各种材料的输入都能有所积累。
