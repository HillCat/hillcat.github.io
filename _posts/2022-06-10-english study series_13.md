...
学语言需要有一个好的积累手段，而切换不同的材料做尝试，也需要时间成本，切换材料的成本太高，可能导致某些长期已经形成的英语学习好习惯被打破，或者长期待在一种单一材料的舒适区内无法自知而陷入瓶颈期。类似anki的这种制卡或者划词体系，它可以适应的学习材料类型广泛，可以让我们不用担心往上攀爬过程中去频繁切换学习方法。
