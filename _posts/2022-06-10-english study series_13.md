...
我在2020年因为学anki，看了大量的`Matt vs Japan`的youtube视频和国外英文博主的anki相关文章，对于anki的使用积累了不少经验，本文仅仅是刷美剧这个细分领域，没有接触过anki的可以单独使用美剧卡片。仅针对美剧，提供一个独立的方法，探索它对美剧听力和日常口语的训练方式。作为A3阶段的辅助工具。如果你以前已经有了自己的一套方法，本方法仅供参考。
