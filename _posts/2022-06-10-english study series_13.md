...
美剧题材和书本的题材一样，有很多种类，剧情好的不一定适合学英语，而某些生活类的剧又太枯燥，选择的试错成本高，要找到适合自己兴趣的剧，就得平时多看剧，看书也是一样，平时要有看原版书的习惯。原版书的题材，美剧的题材都非常多，各有侧重点，比如生活类的美剧，偏向于零碎的英文口语，并不能很好的锻炼到自我语言组织逻辑。观看生活类的口语可能需要几个月甚至半年积累，然后切换到TED演讲类英文这种语言组织和逻辑比较缜密的材料，而雅思口语考试很多时候倾向于TED这种类型，就是给考生一个话题，要你自己组织语言。美剧无法解决这个语言组织能力的问题。只能解决日常生活口语的问题。如果要更上一层楼，完全用口语进行20分钟的不间歇表达这种，还需要引入英文写作训练。一开始可能无法达到那么高的水准，可以先从最简单的生活剧开始，慢慢过渡到20分钟的持续口语输出这种。这是一个漫长的训练过程。每到达一个阶段，需要自己思考，并设计出符合自己的学习方法。

基于以上的策略，美剧先解决零碎的听懂，需要大量看生活剧，之后再过渡到，能够就某一个话题，进行持续口语输出，这不正是我们心心念念所追求的东西吗? 具体可以参考`Ruri Ohama`的亲身经历：[https://youtu.be/NQlFIrSZiIE](https://youtu.be/NQlFIrSZiIE)。anki+mpv这种制卡的方式是一个不错的进入美剧学习这个领域的`起手式`。首先解决如何做笔记、如何整理笔记、如何高效复习3大问题。从一个点切入，为快速过渡到真正的口语输出阶段打下坚实的基础。

**学到什么程度就不需要anki了？**

能够不开字幕看懂大部分的youtube视频和美剧的时候，几乎就不需要借助anki这种单词工具了，这个时候可以进入下一个阶段。下一阶段是回到看书上面来，每当看完一个章节的时候，尝试着自己用英语讲述你看到的这个章节都讲了些什么内容，发表下自己的看法等等，这种训练方式需要有前提基础，就是前期你已经进行了大量的美剧输入(各种TV Show，访谈节目)，并且使用anki复习了很多这种卡片，有过很多次的复习，很多口语表达都刻印到脑子里了，有了这些之后开始尝试复述。尽量用之前积累的东西去口述文章内容。这种复述过程，会用到之前积累的这些卡片素材，坚持一段时间之后，口语能力就会大大提升。这种复述文章的方法，其实就是新概念3，亚历山大推荐的一种方法，youtube播主`Ruri Ohama`就是这么训练自己英文口语的。
...
如果是长时间使用anki，卡片的体积应该是会轻易超过1G的，下面是1万3千张卡片的容积，达到了1.5G，其中美剧卡片并不多，随着美剧卡片的增多，这个体积应该还会快速增加。好在anki官方对于这块并没有容量的限制。所以对于视频卡片而言，不用太过担心。我相信卡片库有比这个体积大得多的人。
