...
本方法可用来修炼美剧，锻炼口语；另外还可以用来修炼口语组织逻辑能力，视具体的剧的类型而定，像youtube的TED演讲倾向于口语逻辑组织能力。而美剧这种倾向于日常口语，前者比较缜密，后者比较松散。yotube播主自说自话的视频，倾向于个人表达。总之，不同的视频积累的效果倾向不一样。文本介绍的视频制卡，提供了一种普遍适用的方法。
