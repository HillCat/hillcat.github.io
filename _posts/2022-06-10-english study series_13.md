...
本文介绍的这种anki制卡方法，最早可以追溯到subs2srs制卡，来至于youtube，B站搜索`subs2srs`也能够找到教材。这个东西已经过时了，1年前我也尝试过subs2srs插件没有尝试成功，这次用的是另外一个新插件，跟subs2srs差不多，都是同一个人发明的方法。

看美剧学英语一定要做笔记，有了这个插件就可以把美剧笔记做成anki单词卡片，带mp4视频和mp3音频。对口语和听力特别管用。目的是为了增强听力和口语记忆，把经典的句子摘抄下来，把重要内容记录到卡片上，使用零碎时间在手机上复习。传统看美剧做笔记很繁琐，要去切割音频，到处找字幕，甚至有人把美剧放到ipad里面重复了一遍又一遍，效果也没见得有多好，时间久了还是忘记了。

如果不使用anki，就只能使用传统的那种方法，比如下面这样：

*“发现了那种让自己百看不厌的经典英文影片，通过全能音频转换通软件将它的MP3提取出来，然后到网站上下载完整的英文字幕，再用LRC歌词编辑器将它做成同步显示歌词文本，放到自己的MP3或者电脑里，随时温习，处处操练。不知不觉这部影片的精髓尽入脑海，随时引用。从而达到通过影视学英语的最终目的。”*

里面提到了`随时温习，处处操练，随时引用`，甚至弄成mp3反复听，跟读模仿练口语 等等操作。同样的目的，用视频卡片就能做到。

如下，保存了视频和音频还有台词，可以反复做听力练习，反复做跟读练习。跟其他方法没区别，关键是把时间碎片化了，复习的时候可以在手机上操作。而且是专挑那些重点的地方复习，而不是每次把整个剧都重复看一遍。

![66667777](/images/posts/66667777.gif)

下面说下怎么弄这个东西，先说下我电脑配置情况：window10 pro Version 22H2 (中文界面改为了英文界面)；Anki Version ⁨2.1.55 QT5(英文界面)。

另外，在操作之前，**强烈建议**把文件夹视图调整为：显示文件名后缀。
