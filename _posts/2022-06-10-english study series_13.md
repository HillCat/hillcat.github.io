...
美剧卡片的制作，我在2021年从youtube看到过，最早来至于[youtube](https://www.youtube.com/watch?v=bbg6ztWecbU)播主`Matt vs japan`，使用mpv+anki制卡，功能非常强大，美剧卡片，对于看美剧学口语而言至关重要。特别是在国内没有语言环境的情况下，能够随时随地掏出手机来复习美剧卡片，对于口语和听力，会起到潜移默化的作用。弥补了语言环境受限的弊端。

美剧卡片复习策略:mp4和mp3可以帮助回忆剧情，复习口语，复习的时候也可以模仿跟读。同时兼顾听力和口语训练。而且日后这些卡片还可以导出，打印出来，作为口语输出材料。从有声书到美剧，使用anki可以做到一脉相承。
