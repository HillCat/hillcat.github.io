...
本方法可用来修炼美剧，锻炼口语；另外还可以用来修炼口语组织逻辑的积累，视具体剧的类型而定，像TED演讲这类的20分钟英文适合用来研究口语逻辑组织能力。而美剧这种适合用来研究日常生活口语。yotube播主那种英文自说自话的节目，也比较适合用来针对口语考试场景，考察语言组织逻辑能力。总之，视频类的材料都适合用本方法。
