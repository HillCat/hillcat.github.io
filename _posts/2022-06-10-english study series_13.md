...
美剧卡片的制作，我在2021年从youtube看到过，最早来至于[youtube](https://www.youtube.com/watch?v=bbg6ztWecbU)播主`Matt vs japan`，使用mpv+anki制卡，功能非常强大，美剧卡片对于看美剧学口语而言至关重要。特别是在国内没有语言环境的情况下，能够随时随地掏出手机来复习美剧卡片，对于口语和听力，会起到潜移默化的作用。如果你使用anki进行过有声书的制卡经历，并且大幅度提升过词汇量和听力，应该能明白这种方法有多么重要。

美剧卡片复习策略:mp4和mp3可以帮助回忆剧情，复习口语，复习的时候也可以模仿跟读。同时兼顾听力和口语训练。这些卡片还可以导出，打印出来，作为口语训练材料。从有声书到美剧，使用anki可以做到一脉相承。所有过往的学习经验，平滑过渡到美剧。以前的经验，在美剧这里同样适用。
...
2.系统完整性导致的问题。需要重装系统。(尽量安装[微软官方镜像iso文件](https://www.microsoft.com/zh-cn/software-download/windows10)刻录的windows系统，激活码在[淘宝10元店](https://s.taobao.com/search?q=windows%E6%BF%80%E6%B4%BB&commend=all&ssid=s5-e&search_type=item&sourceId=tb.index&spm=a21bo.jianhua.201856-taobao-item.2&ie=utf8&initiative_id=tbindexz_20170306)有售)。如果你的windows系统是windows10以前的版本，没有配备PowerShell命令行工具，那么请自行百度安装PowerShell。
...
把一个方法用成自己的习惯，持续积累，可能就是最适合自己的方法。根据我2年来的观察，成年人自学语言，学到比较熟练的地步，大概需要5年时间。比如:`Matt vs Japan`精通日语花了5年时间，Giovanni Smith通过汉语HSK6考试花了5年时间------新汉语水平考试*HSK*（6级),也就是外国人汉语考试的最高等级。这2个人是把外语学到了较高的考试等级，如果对于我们学英语而言，他们学外语相当于学到了雅思8~9分水准，用的都是anki。如果要借鉴anki这块的经验，他们两位其实都算是成功案例，他们在youtube分享的视频，非常值得研究。我觉得anki特别适合程序员来学英语，Anki的DIY能力前所未有的强大，划词制卡和美剧制卡，几乎可以通吃所有类型材料。这让我们不用一直去换方法，容易形成长期习惯。一套方法贯穿几年都没问题，让注意力都集中到学语言本身。
