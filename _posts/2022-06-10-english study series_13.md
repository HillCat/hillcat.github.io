...
可能会发现，我发的这些地址都是英文的，有时候即便是研究英文自学方法，本身对于英文的阅读能力也有要求，还得懂一些电脑软件原理。很多资料看不懂，几乎没法研究这些工具。这也是使用视频制卡的人非常少的原因，对于小白，这个操作繁琐程度直接估计就劝退99%的人了。对于长时间坚持下来的人而言，这点时间其实算不了什么。
