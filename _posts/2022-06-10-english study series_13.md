...
此方法需要你电脑配置环境一切都安装顺利，比如安装chocolatey之后，再通过chocolatey去安装mpv播放器，youtube-dl,ffmpeg。以及要求操作者懂anki使用经验，要设置单词卡片的字段映射模板。一切准备好之后，看美剧的时候开着英文字幕，快捷键B按下之后，mpv播放器和anki插件会自动提取当前美剧片段的mp4和音频，还有台词，给你制作成卡片。这比我之前推荐的sharex手工去截取音频和视频要高效方便得多。最为重要的一个点，我觉得，还是美剧贴近真实生活，并且是真实材料的听力训练。反复复习这些mp4片段，真的能提升口语和听力。对于有声书阅读，真的是大大的补充。
