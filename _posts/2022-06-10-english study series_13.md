...
最终的效果大致如下:mp4和mp3可以帮助回忆剧情，复习口语，复习的时候也可以模仿跟读。同时兼顾了听力/口语/阅读积累。而且日后这些卡片还可以导出，打印出来，作为口语和写作输出的材料。
...
在操作之前，**强烈建议**把文件夹视图调整为：显示文件名后缀；并且电脑开启全局帆樯。如果安装失败，请考虑是否是樯的问题，或是系统完整性导致的问题(尽量使用正规渠道的IOS系统镜像安装windows系统)。
...
区分字体颜色之后，做出来的卡片一目了然。也能够更加突出重点。实际使用来看，美剧制作的卡片，难度要比有声书/外刊/新闻这些题材来源的卡片简单太多，而且也更加符合口语习惯，非常适合作为口语输出的前期积累。
