...
美剧还有一个缺点就是切换材料相对书本而言，比较迟钝。比如生活类的美剧，偏向于零碎的英文口语，并不能很好的锻炼到自我语言组织逻辑。观看生活类的口语可能需要几个月甚至半年积累，然后切换到TED演讲类英文这种语言组织和逻辑比较缜密的材料，而雅思考试很多时候倾向于TED这种类型，就是给一个话题，要你自己组织语言。看传统的美剧无法解决这个语言组织能力的问题。但是可以解决日常生活工作口语的问题，因为这些都是零碎的口语。如果要更上一层楼，完全用口语进行20分钟的不间歇脱口而出这种，可能还需要锻炼写作能力和即兴演讲能力。循序渐进的方法，还是先从最简单的，零碎的题材开始积累，慢慢过渡到可以就某一个话题持续20分钟的英文口语输出。

以上策略，先解决零碎的这种美剧对话可以听懂，就需要大量看美剧学英语，anki+mpv这种制卡的方式，解决了以下3个关键问题：1.美剧如何做笔记，2.美剧如何整理笔记，3.美剧如何高效复习。

学语言需要有一个好的积累手段，而切换不同的材料做尝试，也需要时间成本，切换材料的成本太高，可能导致某些情况下长期呆在舒适区，或者长期待在一个盲区内无法自知，我使用anki的一个原因就是，这套制卡或者划词体系，它可以解决学习题材的切换问题。避免长期陷入某些舒适区而无法继续拓展自己英语的边际。这是全家桶解决方案的好处。
