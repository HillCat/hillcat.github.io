...
去官方下载新版本，看看是不是跟自己的版本号一致，如果版本号高于自己安装的版本号，那就是因为NetFlix官方升级了防盗功能，原则上NetFlix官方是禁止第三方App下载它们具有版权的视频的，会不定期更新这块的漏洞，FlixGrab为了跟上奈飞官方的这种补漏措施，也会跟着频繁升级。如果半路中官方出现了升级版本，你本地运行的时候，会提示错误，都是英文提示，大概意思就是说`你的浏览器版本太低`之类的提示。出现这种提示就去官方网站下载之后重新覆盖安装就可以了。
