...
我上面只是举了Giovanni Smith的例子，其实Matt vs Japan他学日语也有类似经历，他后来创建的会员群里面大部分的学员，都是使用"看剧"的方式学语言。看剧我一直没有找到比较好的制卡方式，血的经验也再次证明了看剧的重要性。看剧制卡配置方法写篇文章记录下，其他有需要的朋友作为参考。细节部分的操作，就仁者见仁智者见智了。这里只讲安装和配置部分。
...
具体的字段配置，请参考我上面这个截图。这些配置全部完成之后，点击ok按钮，然后回到下面那层窗口界面，点击那个界面种的`Open File`就可以直接通过这个插件打开本地电脑磁盘上的美剧来观看了，anki插件会自动唤醒mpv播放器来播放被你选中的那个视频，美剧需要有英文字幕才行，制作卡片的时候才能把英文台词给提取到卡片中。
