...
下面的文字被打上了删除线，是很久之前的方法，留做纪念不再使用。。。。
...
少数情况下会遇到**就算是有词典在手，也不一定可以查到单词的准确意思**，是因为原版材料和非原版材料的上下文语境完全不一样，原版材料是给母语国家的人使用的，很多短语词汇用法非常灵活多变，有不少句子里面的意思无法100%在词典中查到，看原版英文材料对于查词的速度和精确度是有挑战的，手里必须要有一本好的mdx词典。也是我一直使用PC电脑制卡而很少使用手机移动制卡的原因，第一：划词助手机器自动生成的那些词典释义，很多时候排版视觉效果很差；第二：划词助手机器翻译的解释，不是真正想要的那个意思，给日后的单词复习理解造成困扰。所以大部分的时候还是需要在PC电脑上面对划词助手制做的卡片进行二次加工。
