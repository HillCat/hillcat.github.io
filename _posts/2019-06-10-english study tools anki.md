...
使用anki最大的一个前提，就是保证录入anki的单词，释义要准确。把相关度最高的释义放在卡片的顶部，让复习的时候一眼就看到最准确的释义，包括单词的词性。其他不重要的释义可以不做记录，或者放到靠下的位置，复习卡片的时候就会知道，那个释义是当句子中的，哪个释义不是。比如下面这个单词，一眼扫过去就知道，它在当前句子中是名词，另外它还有动词的意思。
