...
2. 单词放入anki里面，编辑起来比较费时间，麻烦，没有'墨墨背单词'那样子的app傻瓜化。
   ...
   由于急功近利，很多人看书的时候，查词典都是随便查一查，第一次遇到生词的时候，查的意思就是错的，导致丢进anki卡片中的是个错误的释义。复习了很多遍，也懒得再去深加工整理，就这样子一遍一遍刷anki，没有想过要再次对已有的单词卡片内容进行一定的修缮工作，对单词的理解始终停留在单词’第一次入库‘时候的印象，单词扔进anki里面之后再也不想去编辑修缮。记不住还是记不住。这样子，大量摸棱两可没有搞清的单词越堆越多，最后崩溃。
...
我见过的anki用得最久的案例，别人用了5年，积累了2万多单词卡片。外语达到母语者水平，这个案例就是[Matt](https://www.youtube.com/channel/UCpf4BknRWAjb_oYIHoMDGVg)。重点要解决的是如何减轻复习压力，让学习新的东西的速度和复习旧的东西的速度达到一个平衡。这就需要既能把控学习材料的难度，又能把控好anki这边使用的技巧。并且这种持续的平衡状态要保持1~3年的时间。所以学习策略上，循序渐进就是一个极为重要的关键因素。这也是为什么，我在谈论anki的时候，我一般还有其他策略上的配合。也就是说我学习的材料的难度都不是很高。因为我要控制好我每天接触到的生词的数量。如果是越级，去看美剧，那么必然，需要丢弃掉很多不认识的单词，只挑选你自己觉得重要的一些生词。正是因为有anki的限制，所以自学这块选择一个等级难度梯度变化的策略是非常必要的。但是这个也不是绝对，还是有其他方法可以做到既快速摄取生词，又能兼顾生词复习压力不那么大的，两全的办法。所以，这里再次提到独立思考力的重要性。 这些都脱离不了实践，比如，最近我开始变速学习有声书(以前都是匀速)，就是在测试这块自己的适应性，大量输入的情况下，anki的这种弊端要如何避免，这也是有时候我会思考的地方(就是说‘你学得越快，你复习的压力会越大’)。也有可能一些假设根本不存在或者不用担心。所以，理论方面的知识很多时候可以避免走弯路，特别是要借鉴别人的一些经验教训。
