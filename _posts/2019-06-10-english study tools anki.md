...
有时候不得不面对单词堆积太多而没时间复习的问题，如果实在太忙，没空搞英语，也行。这里提供几个方法，把单词的复习给延后。首先第一个方法就是创建过滤器，来过滤出那些比较紧急的单词，优先复习一些比较紧急的单词。另一个方法就是把未来某天的复习压力给调低。如果某些单词确实比较难记忆，则使用一些词根词汇，或者影视剧里面的情景进行辅助记忆，避免某些生词复习了很多遍还是记不住。
