...
anki是一个带有争议性的话题，因为anki对新手不太友好，它的使用太依赖于技巧和经验的积累，使用不当很容易走火入魔，市面上，anki被人批评或者被人误解，大多是一些电脑小白使用不当导致的。anki这类工具对于电脑高手比较适合，特别是程序员群体。anki的操作成本，在于它是开源的，很多使用技巧都是需要自己摸索的，并不是一个傻瓜式的工具，特别是学习美剧的时候(mvp player + 外挂字幕 +lua脚本+anki+sharex+在线词典助手制卡），这种5~6种技术混搭制卡的用来学习美剧的方法本来就比较复杂。我最先是从油管看到的[Matt的方法](https://youtu.be/bbg6ztWecbU)，他是看‘美剧’学日语，毕竟anki是日本人发明的，在学习日语的群体中，anki非常流行，在看到Matt推荐的这套技巧之后，我把该方法引入到自己的英文美剧学习中，收到了极好的效果，堪比[人人词典](https://www.91dict.com/words?w=manifest)`场景例句`的那种效果，真正体会到容易的东西不简单，简单的东西不容易)。anki的定位，就像《王者荣耀》手游里面的角色定位一样，anki是属于荆轲这种刺客型职业定位，很吃操作，各种奇技淫巧，如果玩好了，学习效率翻倍。
