...
另外还可以通过标记的颜色，筛选出来一些很难的词进行复习，或者进行编辑：

<img src="https://cs-cn.top/images/posts/flag_filters844.png"/>

比如，有时候我在地铁刷单词的时候，突然发现有个单词的解释给弄错了，我想要在电脑上进行编辑，但是人又在外面不方便，怎么办，那就可以先在手机上标记这个单词，比如给它一个紫色的标记，等有空的时候，回到电脑上把紫色的单词筛出来，编辑好之后，再去掉紫色标记。
