...
如果你对Anki的参数理解得更好，建议你看看上面推荐的第二个视频。特别是叫你怎么避免“Ease地狱”，就是说不要给自己放水放得太多了，明明一个单词没有记住，但是还是点击了Easy那个按钮，那么就会导致你正在学习中的单词，复习间隔被拉得很长很长，不利于你记忆。第二视频，我认为，是讲Anki参数讲得比较好的。
