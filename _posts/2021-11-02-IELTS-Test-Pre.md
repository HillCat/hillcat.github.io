...
刘洪波的刷完，单词盲点录入anki集中复习。然后听力这块，还可以专门成立一个错题本建立到anki中，针对于 王陆 编著的那本《雅思王听力真题语料库》里面大概会有 连读，弱读，等一些听力拼写错误的单词，要重点标记出来，可以做成那种答题卡形式的anki卡片加以强化训练。其实有anki这个备考工具，进行这种刻意训练的错题本还是比较简单的。
