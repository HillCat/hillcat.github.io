...
MatLab软件的操作和使用。在学习高等数学的时候，经常用到一些仿真的方式来加快某些公式的理解，可以通过调试仿真参数生成曲线图或者3D图片的方式来增加对于抽象概念的理解。类似的软件在手机端也有很多，最强大和专业的还是MatLab.工科类必读课程：高等数学(上、下)、线性代数、概率论与数理统计。考研的话，数学会考高数、线代和概率这三门必考。
