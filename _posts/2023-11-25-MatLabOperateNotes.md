...
MatLab软件的操作和使用。在学习高数的时候，经常用到一些仿真的方式来加快某些公式的理解，工科类必读课程：高等数学(上、下)、线性代数、概率论与数理统计。考研的话，数学会考高数、线代和概率这三门。对于程序员而言，图像处理，机器视觉很多地方用到线性代数里面的知识。而MatLab在某些课程方便的配套资源是比较多的，适合用来作为学习辅助工具。
