...
在以往的anki版本中，我是不会去可以尝试背诵单词的，为何现在我会使用背诵的方式呢？

原因主要有2点：

1.vocabulary这个网站的释义确实让我体会到更加容易记住一个单词；并且恰好有人已经制作了具备vocabulary释义的COCA20000的ANKI词牌。

2.anki的最新版本大幅度改良和复习的算法，结合FSRS4Anki  Helper插件的最新机器学习算法，我们可以优化COCA20000单词的复习进度。

有了上面两大杀器的加持，并且自己也有了较高的词汇积累，所以背完剩下的词汇难度应该不会太大。



使用方式：导入COCA20000词牌，把我们已经熟悉的单词进行suspend暂停操作。使用FSRS4Anki  Helper插件训练之后得到的优化参数来背诵这些生词。结合外刊阅读进行巩固。
