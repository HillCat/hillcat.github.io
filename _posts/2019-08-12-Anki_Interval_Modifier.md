...
间隔地狱，指的是由于使用Anki的习惯不当，导致恶心死循环，陷入到了“无限循环地复习某些单词”的境地，并且这些单词以高频率的方式展示在你每日的复习列表中，好像有些单词永远记不住，永远在无限地刷。一般这些单词的Ease Factor值都是130%。如果你的单词卡中存在大量的这种单词，势必会加大你的复习负担。就需要对这部分单词进行一定的处理，要么完善它们，要么提升它们的Ease Factor值。
