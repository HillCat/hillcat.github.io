...
间隔地狱，指的是由于使用Anki的习惯不当，导致恶心死循环，陷入到了“无限循环地复习某些单词”的境地，并且这些单词以高频率的方式展示在你每日的复习列表中，好像有些单词永远记不住，永远在无限地刷。一般这些单词的Ease Factor值都是130%。如果你的单词卡中存在大量的这种单词，势必会加大你的复习负担。就需要对这部分单词进行一定的处理，要么完善它们，要么提升它们的Ease Factor值。还一个就是要分析下自己最近阅读的有声书或者录入生词的时候，是不是录入了大量的超纲词，要重点分析下这些Ease Factor为130%的生词。如果确实是自己阅读的材料太过于抽象，导致录入Anki中很多抽象的单词而导致自己记不住，那么就要考虑更换一下材料或者可以换动画片或者美剧，因为这些材料有声音和图片，更加利于自己理解单词。不至于陷入“总是刷单词，就是记不住”的尴尬境地，这种就是陷入了“低间隔地狱”。
