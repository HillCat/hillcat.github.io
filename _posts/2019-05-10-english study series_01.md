...
听力方面：美剧大部分单词已经建立了听感。IT方面的词汇量已经够用，并且可以较为轻松看懂老外的技术视频。词汇量以美剧作为主要输入材料，配合有声书一起，扩充阅读和听力词汇。单词发音这块已经基本掌握了句子的韵律和节奏。为口语输出和影子跟读打下了不错的基础。并且我也相信，用不了多久，口语我也能够突破。最近英语的训练方式是：我在用NetFlix和Youtube做疯狂听力输入。
