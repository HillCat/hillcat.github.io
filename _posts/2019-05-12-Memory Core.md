...
使用anki有很长时间了，发现了一些记单词的规律，在此分析总结一下我的心得体会。貌似我的这些文章都挺冗余的，没办法，因为有很多人需要看下我的细节是如何操作的，所以就写得比较长。以后可能删掉这些文章，不喜勿喷。下面从我的anki库中抽取一些真实的数据来讲解。估算下，提升英语需要投入多大的时间成本。这里主要是看单个单词的时间投入成本，没有计算平时的阅读输入和听力输入美剧那些时间投入，如果总的算进来，是超过1000小时的。就纯粹来看，复习单词，需要投入多少时间。
...
另外，**复习单词一定要听单词发音，非常非常非常重要**，可以激活你的听力词汇。现在我的词汇量和语感，还有听感，阅读这种难度的材料问题不大：[Abp框架文档](https://docs.abp.io/en/commercial/latest/getting-started?UI=NG&DB=Mongo&Tiered=No)，并且看Youtube里面的技术类分享视频,比如这种：[https://youtu.be/YC4ewe7Rbl4](https://youtu.be/YC4ewe7Rbl4)，90%情况下直接不看字幕是可以的。这个对于研究.net core底层框架原理和一些最新的技术有很大的优势。其实只要关注国内那些大牛都会发现，其实他们的英文能力都不差。甚至我发现有些大牛的英文词汇量可能接近母语者大学毕业生的水平，也就是接近1.5万词汇量，听力肯定是不在话下。词汇量8000的时候可以做到非常自由了，何况1.5万，当然可以做到丝滑般的体验。基本上不太会收到技术书籍和文档的限制，只要想了解一个技术原理，基本通过英文类资料就可以马上搞定。在不考雅思托福的情况下，英文其实就已经可以带来很客观的收益，这种收益只有自己知道，隐性的。
