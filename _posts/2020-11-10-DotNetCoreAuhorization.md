...
授权认证这块，还有一个专有名词叫做“[基于策略的授权](https://docs.microsoft.com/en-us/aspnet/core/security/authorization/policies?view=aspnetcore-5.0)”，指的就是policy，policy规则的自定义在下文有详细分析。
