...
Policy就是Authorization Function，拿到User Context之后，对User数据进行具体的验证的Function，对应的是一组处理规则。微软.net core框架封装了一些常用的操作，对系统提供的Authorization命名空间下的API添加option设置，实现policy策略。
