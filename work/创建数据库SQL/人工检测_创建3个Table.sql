...
CREATE TABLE IF NOT EXISTS `bge_manual_monitor` (
  ...
  `company_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '监测单位名称',
...
-- Dumping data for table gdbs_dev.bge_manual_monitor: 10 rows
...
-- Dumping structure for table gdbs_dev.bge_manual_monitor_dict
...
-- Dumping data for table gdbs_dev.bge_manual_monitor_dict: 13 rows
...
-- Dumping structure for table gdbs_dev.bge_manual_monitor_point_detail
CREATE TABLE IF NOT EXISTS `bge_manual_monitor_point_detail` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `point_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '测点名称, 比如：墩-10A',
  `drop_down` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '沉降量',
  `temperature` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '温度',
  `crack_width` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '裂缝宽度',
  `distance` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '位移',
  `reactivity` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '应变 ',
  `angle_x` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '倾角XS',
  `angle_y` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '倾角YS',
  `cable_force` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '索力',
  `wind_speed` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '平均风速',
  `wind_direction` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '风向',
  `wet` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '湿度',
  `height` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '高度',
  `overturn` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '倾覆',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
-- Dumping data for table gdbs_dev.bge_manual_monitor_point_detail: 10 rows
