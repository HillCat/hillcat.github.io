...
namespace  GDBS.BridgeService.Domain 
 { 
     ...
     {  
        ...
        /// 测点名称, 比如：墩-10A 
        /// </summary>
        [Column("point_name",TypeName ="varchar(255)")]
        public string    PointName { get; set; } 
        /// <summary>
        /// 沉降量 
        /// </summary>
        [Column("drop_down",TypeName ="varchar(20)")]
        public string    DropDown { get; set; } 
        /// <summary>
        /// 温度 
        /// </summary>
        [Column("temperature",TypeName ="varchar(20)")]
        public string    Temperature { get; set; } 
        /// <summary>
        /// 裂缝宽度 
        /// </summary>
        [Column("crack_width",TypeName ="varchar(20)")]
        public string    CrackWidth { get; set; } 
        /// <summary>
        /// 位移 
        /// </summary>
        [Column("distance",TypeName ="varchar(20)")]
        public string    Distance { get; set; } 
        /// <summary>
        /// 应变  
        /// </summary>
        [Column("reactivity",TypeName ="varchar(20)")]
        public string    Reactivity { get; set; } 
        /// <summary>
        /// 倾角XS 
        /// </summary>
        [Column("angle_x",TypeName ="varchar(20)")]
        public string    AngleX { get; set; } 
        /// <summary>
        /// 倾角YS 
        /// </summary>
        [Column("angle_y",TypeName ="varchar(20)")]
        public string    AngleY { get; set; } 
        /// <summary>
        /// 索力 
        /// </summary>
        [Column("cable_force",TypeName ="varchar(20)")]
        public string    CableForce { get; set; } 
        /// <summary>
        /// 平均风速 
        /// </summary>
        [Column("wind_speed",TypeName ="varchar(20)")]
        public string    WindSpeed { get; set; } 
        /// <summary>
        /// 风向 
        /// </summary>
        [Column("wind_direction",TypeName ="varchar(20)")]
        public string    WindDirection { get; set; } 
        /// <summary>
        /// 湿度 
        /// </summary>
        [Column("wet",TypeName ="varchar(20)")]
        public string    Wet { get; set; } 
        /// <summary>
        /// 高度 
        /// </summary>
        [Column("height",TypeName ="varchar(20)")]
        public string    Height { get; set; } 
        /// <summary>
        /// 倾覆 
        /// </summary>
        [Column("overturn",TypeName ="varchar(20)")]
